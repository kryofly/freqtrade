...
def plot_analyzed_dataframe(args) -> None:
    ...
    trends, maxslope, minslope = trendy.gentrends(dataframe['close'])
    print(trends)
    ...
    trendy_trends = go.Scattergl(
        x=df['date'],
        y=trends['Data'],
        name='trend-data'
    )
    trendy_max= go.Scattergl(
        x=df['date'],
        y=trends['Max Line'],
        name='trend-max'
    )
    trendy_min= go.Scattergl(
        x=df['date'],
        y=trends['Min Line'],
        name='trend-min'
    )

    #trendy_maxslope= go.Scattergl(
    #    x=df['date'],
    #    y=maxslope,
    #    name='trend-maxslope'
    #)
    #trendy_minslope= go.Scattergl(
    #    x=df['date'],
    #    y=minslope,
    #    name='trend-minslope'
    #)
    ...
    fig.append_trace(trendy_trends, 1, 1)
    fig.append_trace(trendy_max, 1, 1)
    fig.append_trace(trendy_min, 1, 1)
    #fig.append_trace(trendy_maxslope, 1, 1)
    #fig.append_trace(trendy_minslope, 1, 1)
    ...
    #fig['layout']['yaxis2'].update(title='trends')
