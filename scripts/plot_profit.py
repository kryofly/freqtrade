...
def plot_profit(strategy, args) -> None:
    """
    ...
    print('############## x1:', dataframes.items())
    print('############## len:', len(dataframes.items()))
